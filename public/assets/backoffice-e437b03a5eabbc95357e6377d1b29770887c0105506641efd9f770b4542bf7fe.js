...
$(document).ready(function () {
    ...
    $(".level-modal").on("hide.bs.modal", function(e) {
      ...
      $("#new_level").trigger("reset");
      var nl = $("#new_level");
      $.rails.enableFormElements(nl);

      
    });
  
    $("#new_level").on("submit", function(e) {
      e.preventDefault();
      $.ajax({
        method: "POST",
        ...
        error: function (jqXHR, textStatus, errorThrown) { console.log("Erro lancado " + errorThrown); }
      });
    });
